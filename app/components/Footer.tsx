              ...
              <div className="md:flex md:justify-between">
                  <div className="mb-6 md:mb-0">
                      <a href="/" className="flex items-center">
                          ...
                          <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap">FindMeParking</span>
                      </a>
                  </div>
                  <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                      ...
                      <div>
                          ...
                          <ul className="text-body font-medium">
                              <li className="mb-4">
                                  <a href="https://github.com/James-Schaffer/LeicesterCS_Hackathon_2025" className="hover:underline ">
                                      Github
                                  </a>
                              </li>
                              <li>
                                  <a href="https://discord.gg/zc6rDUDf" className="hover:underline">
                                      Discord
                                  </a>
                              </li>
                          </ul>
